                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade " id="large" role="tabpanel">
                                                    <div class="row">
                                                        <%
//                                                            ArrayList<SanPham> sanPhams = SanPhamDAO.getInstance().select();
                                                            for(int i = sanPhams.size() - 1 ; i >= 7; i--){
                                                                String maSanPham = sanPhams.get(i).getMaSanPham() ;
                                                                String tenSanPham = sanPhams.get(i).getTenSanPham() ;
                                                                Double giaSanPham = sanPhams.get(i).getGiaSanPham() ;
                                                                ArrayList<String> hinhAnh = sanPhams.get(i).getAnhSanPham() ;
...
//                                                        ArrayList<SanPham> sanPhams = SanPhamDAO.getInstance().select();
                                                        for(int i = 0 ; i < sanPhams.size() ; i++){
                                                            ...
                                                            Double giaSanPham = sanPhams.get(i).getGiaSanPham() ;
                                                            String hinhAnhSanPham = sanPhams.get(i).getAnhSanPham().get(0) ;
                                                            String moTaChiTiet = sanPhams.get(i).getMoTaChiTiet() ;
                                                    %>
                                                    <div class="product_list_item mb-35">
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col-lg-4 col-md-6 col-sm-6">
                                                                <div class="product_thumb">
                                                                   <a href="single-product.jsp"><img src="<%=hinhAnhSanPham%>" alt=""></a>
                                                                   <div class="img_icone">
                                                                       <img src="assets\img\cart\span-new.png" alt="">
                                                                   </div>
                                                                </div>
                                                                ...
                                                                <div class="list_product_content">
                                                                   <div class="product_ratting">
                                                                    ...
                                                                    <div class="list_title">
                                                                        <h3><a href="single-product.jsp"><%=tenSanPham%></a></h3>
                                                                    </div>
                                            ...
                                            <div class="page_number">
                                                ...
                                                <ul>
                                                    <%
                                                        ...
                                                        pages = (pages % 5) == 0 ? ( pages / 5 ): ( pages/5 + 1) ;
                                                    %>
                                                    <li>«</li>
<%--                                                    <li class="current_number">1</li>--%>
                                                    <% for (int i = 1 ; i <= pages ; i++ ) { %>
                                                    <li><a href="pages-shop-list?index=<%=i%>"></a><%=i%></li>
                                                    <% } %>
                                                    <li>»</li>
                                                </ul>
                                            </div>
