                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="header_links">
                                                <ul>
                                                    ...
                                                    <%  String user = session.getAttribute("value_user") +""; %>
                                                    <li><a href="login.jsp" title="Login">Hello: <%=user%></a></li>
                                                </ul>
                                            </div>   
                                        </div>
                                   </div> 
                                    ...
                                    <div class="row align-items-center">
                                       <!--logo start-->
                                        <div class="col-lg-3 col-md-3">
                                            <div class="logo">
                                                <a href="index.html"><img style = "width : 150px ; height : 80px" src="assets\logo.png" alt=""></a>
                                            </div>
                                        </div>
                                        <!--logo end-->
                                            ...
                                            <div class="product_active owl-carousel">
                                                <div class="col-lg-3">
                                                    <div class="single_product">
                                                        ...
                                                        <div class="product_content">
                                                            <span class="product_price">$60.00</span>
                                                            <h3 class="product_title"><a href="single-product.jsp">Maecenas sit amet</a></h3>
                                                        </div>
                                                        <div class="product_info">
                                                            <ul>
                                                                <li><a href="#" title=" Add to Wishlist ">Add to Wishlist</a></li>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="single_product">
                                                        ...
                                                        <div class="product_content">
                                                            <span class="product_price">$50.00</span>
                                                            <h3 class="product_title"><a href="single-product.jsp">Sed non turpis</a></h3>
                                                        </div>
                                                        <div class="product_info">
                                                            <ul>
                                                                <li><a href="#" title=" Add to Wishlist ">Add to Wishlist</a></li>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="single_product">
                                                        ...
                                                        <div class="product_content">
                                                            ...
                                                            <h3 class="product_title"><a href="single-product.jsp">Donec ac congue</a></h3>
                                                        </div>
                                                        <div class="product_info">
                                                            <ul>
                                                                <li><a href="#" title=" Add to Wishlist ">Add to Wishlist</a></li>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="single_product">
                                                        ...
                                                        <div class="product_content">
                                                            <span class="product_price">$50.00</span>
                                                            <h3 class="product_title"><a href="single-product.jsp">Phasellus a arcu</a></h3>
                                                        </div>
                                                        <div class="product_info">
                                                            <ul>
                                                                <li><a href="#" title=" Add to Wishlist ">Add to Wishlist</a></li>
