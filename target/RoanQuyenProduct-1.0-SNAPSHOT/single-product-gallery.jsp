...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>Coron-product gallery</title>
                   ...
                   <!--pos page inner-->
                    <div class="pos_page_inner">  
                       <!--header area -->
                        ...
                        <div class="product_details gallery_details">
                            <div class="row">
                                <%
                                    SanPham sanPham = (SanPham) request.getAttribute("sanPhamDetail") ;
                                    ArrayList<SanPham> sanPhams = SanPhamDAO.getInstance().select();
                                    if(sanPham == null){
                                        sanPham = new SanPham(sanPhams.get(0)) ;
                                    }
                                    ArrayList<String> hinhAnhSanPham = sanPham.getAnhSanPham() ;
                                    String tenSanPham = sanPham.getTenSanPham();
                                    String moTaChiTiet = sanPham.getMoTaChiTiet() ;
                                    Double giaSanPham  = sanPham.getGiaSanPham() ;
                                %>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="product_gallery fix">
                                            <div class="product_gallery_thumb">
                                                <img src="<%=hinhAnhSanPham.get(0)%>" alt="">
                                            </div>
                                            <div class="product_gallery_thumb">
                                                <img src="<%=hinhAnhSanPham.get(1)%>" alt="">
                                            </div>
                                            <div class="product_gallery_thumb">
                                                <img src="<%=hinhAnhSanPham.get(2)%>" alt="">
                                            </div>
                                            <div class="product_gallery_thumb">
                                                <img src="<%=hinhAnhSanPham.get(3)%>" alt="">
                                            </div>
                                        </div> 
                                    </div>
                                    <div class="col-lg-6 col-md-6">
