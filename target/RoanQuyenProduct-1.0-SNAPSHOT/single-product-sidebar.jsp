...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>Coron-product sidebar</title>
                                            ...
                                            <div class="product_tab sidebar fix"> 
                                                ...
                                                <div class="tab-content produc_tab_c">
                                                    <div class="tab-pane fade show active" id="p_tab1" role="tabpanel">
                                                        <div class="modal_img">
                                                            <a href="#"><img src="assets\img\product\productbig.jpg" alt=""></a>
                                                            <div class="img_icone">
                                                               <img src="assets\img\cart\span-new.png" alt="">
                                                           </div>
                                                            <div class="view_img">
                                                                <a class="large_view" href="assets\img\product\productbig.jpg"><i class="fa fa-search-plus"></i></a>
                                                            </div>    
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane fade" id="p_tab2" role="tabpanel">
                                                        <div class="modal_img">
                                                            ...
                                                            <div class="view_img">
                                                                <a class="large_view" href="assets\img\product\productbig1.jpg"><i class="fa fa-search-plus"></i></a>
                                                            </div>     
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane fade" id="p_tab3" role="tabpanel">
                                                        <div class="modal_img">
                                                            ...
                                                            <div class="view_img">
                                                                <a class="large_view" href="assets\img\product\productbig2.jpg"> <i class="fa fa-search-plus"></i></a>
                                                            </div>     
                                                        </div>
                                                    </div>
                                                </div>
