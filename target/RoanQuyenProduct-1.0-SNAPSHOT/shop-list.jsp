                                        ...
                                        <div class="sidebar_widget special">
                                            ...
                                            <%
                                                ...
                                                for(int i = 3  ; i < 6 ; i++){
                                                    ...
                                                    String hinhAnhSanPham = sanPhams.get(i).getAnhSanPham().get(0) ;
                                            %>
                                            <div class="special_product_inner mb-20">
                                                <div class="special_p_thumb">
                                                    <a href="chi-tiet-san-pham?maSanPham=<%=maSanPham%>"><img style = "width : 180px ; height : 80px" src="<%=hinhAnhSanPham%>" alt=""></a>
                                                </div>
                                                <div class="small_p_desc">
                                                    ...
                                                    <h3><a href="chi-tiet-san-pham?maSanPham=<%=maSanPham%>"><%=tenSanPham%></a></h3>
                                                    <div class="special_product_proce">
                                                        <span class="old_price"><%=(double)Math.round(giaSanPham * 100/97 * 10) / 10 %>.VND </span>
                                                        <span class="new_price"><%=giaSanPham%>.VND</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <%}%>
                                    ...
                                    <div class="col-lg-9 col-md-12">
                                        ...
                                        <div class="shop_toolbar list_toolbar mb-35">
                                            ...
                                            <div class="page_amount">
                                                <%
                                                    int pages = sanPhams.size();
                                                    pages = (pages % 6) == 0 ? ( pages / 6 ): ( pages/6 + 1) ;
                                                %>

                                                <p>Showing 6 items of <%=pages * 6%> results</p>
                                            </div>
                                        ...
                                        <div class="shop_tab_product">   
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade " id="large" role="tabpanel">
                                                    <div class="row">
                                                        <%
                                                            sanPhams = (ArrayList<SanPham>) request.getAttribute("sanPhamsPages");
                                                ...
                                                <div class="tab-pane fade show active" id="list" role="tabpanel">
                                                    <%
//                                                        ArrayList<SanPham> sanPhams = SanPhamDAO.getInstance().select();
                                                        ArrayList<SanPham> sanPhamsPages =(ArrayList<SanPham>)request.getAttribute("sanPhamsPages");
                                                        for(int i = 0 ; i < sanPhamsPages.size()  ; i++){
                                                            String maSanPham = sanPhamsPages.get(i).getMaSanPham() ;
                                                            String tenSanPham = sanPhamsPages.get(i).getTenSanPham() ;
                                                            Double giaSanPham = sanPhamsPages.get(i).getGiaSanPham() ;
                                                            String hinhAnhSanPham = sanPhamsPages.get(i).getAnhSanPham().get(0) ;
                                                            String moTaChiTiet = sanPhamsPages.get(i).getMoTaChiTiet() ;
                                                    %>
                                                    <div class="product_list_item mb-35">
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col-lg-4 col-md-6 col-sm-6">
                                                                <div class="product_thumb">
                                                                   <a href="chi-tiet-san-pham?maSanPham=<%=maSanPham%>"><img src="<%=hinhAnhSanPham%>" alt=""></a>
                                                                   <div class="img_icone">
                                                                       <img src="assets\img\cart\span-new.png" alt="">
                                                                   </div>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-8 col-md-6 col-sm-6">
                                                                <div class="list_product_content">
                                                                   <div class="product_ratting">
                                                                    ...
                                                                    <div class="add_links">
                                                                        <ul>
                                                                            <li><a href="them-gio-hang?tenDangNhap=<%=tenDangNhap%>&maSanPham=<%=maSanPham%>&soLuong=1" title="add to cart"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a></li>
                                                                            <li><a href="them-danh-sach-mong-muon?tenDangNhap=<%=tenDangNhap%>&maSanPham=<%=maSanPham%>" title="add to wishlist"><i class="fa fa-heart" aria-hidden="true"></i></a></li>
                                                                            <li><a href="chi-tiet-san-pham?maSanPham=<%=maSanPham%>" ><i class="fa fa-eye" aria-hidden="true"></i></a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
...
<%--                                                    <li class="current_number">1</li>--%>
                                                    ...
                                                    <li><a href="pages-shop-list?index=<%=i%>&url=shop-list.jsp"><%=i%></a> </li>
                                                    <% } %>
                                                    <li>»</li>
                                                </ul>
                                            </div>
